...
{
    private readonly SqlAccountCustomerPaymentHelper _customerPaymentHelper;
    public CustomerPaymentController(SqlAccountCustomerPaymentHelper customerPaymentHelper)
    {
        _customerPaymentHelper = customerPaymentHelper;
    }

    /// <summary>
    /// Retrieves customer payments by document number
    /// </summary>
    /// <remarks>
    /// This API fetches customer payments that match the provided document number.
    /// </remarks>
    ...
    /// <summary>
    /// Retrieves customer payments from a certain number of days ago
    /// </summary>
    /// <remarks>
    /// Fetches customer payments based on the number of days before the current date.
    /// </remarks>
    ...
    /// <summary>
    /// Retrieves customer payments from a specific date
    /// </summary>
    /// <remarks>
    /// Fetches customer payments recorded from a given date onward.
    /// </remarks>
